...
export default function BranchesPagination({
  ...
  const t = useTranslations("brand.branches.pagination");
          ...
          {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
            ...
            return (
              <button
                ...
                style={currentPage === pageNum ? { boxShadow: `0 10px 15px -3px var(--brand-text-accent), 0 4px 6px -4px var(--brand-text-accent)` } : {}}
              >
                {pageNum}
              </button>
            );
